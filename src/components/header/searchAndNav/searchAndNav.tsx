import style from "./searchAndNav.module.scss"
import {Link, Location} from "react-router-dom";
import React from "react";

type SearchAndNavProps = {
    location: Location;
}
export const SearchAndNav: React.FC<SearchAndNavProps> = ({location}) => {
    return (
        <section className={style.wrapper}>
            ...
            <Link to="favourite" className={location.pathname === "/favourite" ? style.selected : style.card}>
            ...
            <Link to="dislikes" className={location.pathname === "/dislikes" ? style.selected : style.card}>
                <svg viewBox="0 0 30 30" fill="none">
                    <path fillRule="evenodd" clipRule="evenodd"
